...
c(ecls_dat, param_set, icc_plt, r2_plt, 
  examples_params, examples_spaghetti_plts,
  examples_condition_plt, examples_icc_plt, examples_r2_plt) |>
...
walk(tar_read(condition_plt), print)
```
...
examples_params |>
  ...
  map(\(data) {
    ...
    data |>
      j_gt() |>
      cols_hide(c(example_type, n_bootstraps)) |>
      fmt_number() |>
...
#| column: page
#| layout-ncol: 2
examples_condition_plt_files <- targets::tar_read(examples_condition_plt_files)
examples_condition_plt_files_flat <- unlist(examples_condition_plt_files)
knitr::include_graphics(examples_condition_plt_files_flat)
```
