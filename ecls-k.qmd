...
model_id_idxs <- map(model_ids, 
                     \(model_id) which(
                       str_detect(condition_plt_files, glue::glue("model_{model_id}"))
                     ))

condition_plt_files[model_id_idxs[[1]]] |>
  knitr::include_graphics()
```

## Level-One Predictor Model

```{r model_1_condition_plts}
#| column: page
#| layout-ncol: 2
#| warning: false

condition_plt_files[model_id_idxs[[2]]] |>
  knitr::include_graphics()
```

## Level-One and Level-Two Predictor Model

```{r model_3_condition_plts}
#| column: page
#| layout-ncol: 2
#| warning: false

condition_plt_files[model_id_idxs[[3]]] |>
  knitr::include_graphics()
```

## Cross-Level Interaction Model

```{r model_4_condition_plts}
#| column: page
#| layout-ncol: 2
#| warning: false

condition_plt_files[model_id_idxs[[4]]] |>
  knitr::include_graphics()
```

## Full Model

```{r model_5_condition_plts}
#| column: page
#| layout-ncol: 2
#| warning: false

condition_plt_files[model_id_idxs[[5]]] |>
  knitr::include_graphics()
```
